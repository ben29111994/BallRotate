                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (originalAssetPath.EndsWith(".shadergraph"))
                            Debug.LogWarning(shader.name + " is created with ShaderGraph, but GPUInstacer Setup Node is not added. Please add this node to your graph's position output as the final step.");
                        else
